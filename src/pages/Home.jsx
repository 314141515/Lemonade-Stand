    ...
    <div className="flex flex-col items-center px-6 py-16 font-mono">
      ...
      <div className="w-full max-w-4xl bg-[#ffc800] border-2 border-[#1a1a1a] rounded-2xl p-8 shadow-[4px_4px_0px_#1a1a1a]">
        ...
        <div className="flex justify-end mt-8">
          <Link to="/shop" className="bg-[#1a1a1a] text-white border-2 border-[#1a1a1a] rounded-xl px-5 py-2 text-sm font-bold hover:bg-[#333] transition-all">
            Mere →
          </Link>
        </div>
      </div>

        <div className="w-full max-w-4xl h-px bg-gradient-to-r from-transparent via-[#ccc] to-transparent mt-20 mb-8 fade-up" />
          <FAQ />
